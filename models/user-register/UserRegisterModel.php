...
class UserRegisterModel
{
    ...
    public function validate_register_form()
    {
        ...
        if ('POST' === $_SERVER['REQUEST_METHOD'] && !empty($_POST)) {
            ...
            foreach ($_POST as $key => $value) {
                ...
                if (empty($value)) {
                    ...
                    $this->form_msg = '<p class="form_error">Todos os campos devem ser preenchido!</p>';
        ...
        if (!empty($user_id)) {
            ...
            if (!$query) {
                $this->form_msg = '<p class="form_error">Erro interno. Dados não foi enviados!</p>';
                return;
            } else {
                $this->form_msg = '<p class="form_success">Usuário registrado com sucess!</p>';
                return;
            }
        }
    }
